...
import { PlusIcon, EditIcon, TrashIcon, HomeIcon, GarageIcon, SearchIcon, XCircleIcon, GridIcon, ListIcon } from '../components/icons/Icons';
                                ...
                                >
                                    ...
                                    <td className="px-6 py-4">
                                        <span className={`px-2 py-1 text-[10px] font-semibold rounded-lg uppercase tracking-tight ${
                                            apt.status === ApartmentStatus.Available ? 'bg-green-100 text-green-700' : 
                                            apt.status === ApartmentStatus.ForSale ? 'bg-purple-100 text-purple-700' : 
                                            apt.status === ApartmentStatus.Rented ? 'bg-blue-100 text-blue-700' : 'bg-gray-100 text-gray-700'
                                        }`}>
                                            {apt.status === ApartmentStatus.Available ? 'Libre' : apt.status === ApartmentStatus.ForSale ? 'Vente' : apt.status === ApartmentStatus.Rented ? 'Loué' : 'Vendu'}
                                        </span>
                                    </td>
